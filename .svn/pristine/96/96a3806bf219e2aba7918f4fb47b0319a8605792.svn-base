...
$(function(){
	...
	$('a[href="user.php"]').click(function(e){e.preventDefault(); if(confirm('To restore administrator privileges after entering Client View, you will need to log out and then log back in to your administrator account. Continue?')){location.href = this.href;}});
