...
// add icons section
$formface .= addSubheading('Icons and Styling');
$formface .= addParagraph('Each icon image used on the site was created by me in Paint.NET. With the exception of the Admin button (which is intended to be attention-grabbing, to always'
	. ' make it obvious to a developer to the fact that admin permissions are currently allowed), they were created to give a consistent look and feel to the site. I also added some'
	. ' more CSS styling to make the visuals look less like they were designed by an engineer.');
